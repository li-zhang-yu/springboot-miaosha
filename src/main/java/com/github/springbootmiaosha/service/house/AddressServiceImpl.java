...
public class AddressServiceImpl implements IAddressService {
    ...
    private static final String BAIDU_MAP_KEY = "eeKR0Y814tuWivREefguApYYX7zQGyl1";
    ...
    public ServiceResult<BaiduMapLocation> getBaiduMapLocation(String city, String address) {
        ...
        try {
            ...
            logger.error("Error to encode house addresas", e);
            return new ServiceResult<BaiduMapLocation>(false, "Error to encode house addresas");
        }
